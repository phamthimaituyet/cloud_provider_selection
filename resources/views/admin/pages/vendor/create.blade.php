...
<section class="content" style="padding: 30px;">
    <form action="{{ route('vendors.store') }}" enctype="multipart/form-data" method="post">
        @csrf
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <div class="prod_name">
                        ...
                        <input type="text" name="link_iso" id="inputLinkIso" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <div class="prod_name">
                        <label for="inputCertificate">Link home page</label>
                        <input type="text" name="link" id="inputLinkHome" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <div class="prod_name">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <input type="submit" value="Create new Vendor" class="btn btn-success float-right">
            </div>
        </div>
    </form>
</section>
