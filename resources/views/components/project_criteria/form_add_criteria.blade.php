<form action="{{ route('myProject.addNote', ['id' => $project->id]) }}" method="POST">
    ...
    <div class="container my-3 shadow-none p-3 mb-5 bg-light rounded">
        <div class="list-criteria-1">
            <div class="criteria-elem-1">
                <div class="">
                    <div class="mb-3">
    ...
    <div class="container form-add-criteria-container d-none mt-3 shadow-none p-3 mb-5 bg-light rounded">
        <div class="list-criteria">
            <div class="criteria-elem">
                <div class="">
                    <div class="mb-3">
                        <label for="name" class="col-form-label fw-bold text-danger float-start">Requirements:</label>
